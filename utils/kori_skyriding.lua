...
-- Texture paths
local DOT_TEXTURE = "Interface\\AddOns\\KoriUI\\assets\\cursor\\kori_reticle_dot"
...
local function CreateSkyridingFrame()
    ...
    skyridingFrame = CreateFrame("Frame", "KoriUI_Skyriding", UIParent)
    ...
    -- Apply KoriUI font to cooldown text (deferred to ensure template is initialized)
...
---------------------------------------------------------------------------
_G.KoriUI_RefreshSkyriding = ApplySettings
