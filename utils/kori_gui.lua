...
---------------------------------------------------------------------------
-- FONT PATH (uses bundled Korivash font for consistent panel formatting)
---------------------------------------------------------------------------
local FONT_PATH = LSM:Fetch("font", "Korivash") or [[Interface\AddOns\KoriUI\assets\Korivash.ttf]]
...
function GUI:ShowConfirmation(options)
    ...
    if not confirmDialog then
        ...
        confirmDialog = CreateFrame("Frame", "KORI_ConfirmDialog", UIParent, "BackdropTemplate")
