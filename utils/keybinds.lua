...
SlashCmdList["KORIKEYBINDS"] = function(msg)
    ...
    elseif msg == "proctest" then
        ...
        print("  /korikeybinds macro <name> - Debug a specific macro")
        print("  /korikeybinds find <name> - Find which button has a macro")
        print("  /korikeybinds buttons - Show cached action buttons")
        print("  /korikeybinds key <key> - Check what a key is bound to")
        print("  /korikeybinds trace <button> - Trace a specific button")
        print("  /korikeybinds dominos - Scan Dominos buttons for macros")
        print("  /korikeybinds bartender - Scan Bartender4 buttons for macros")
        print("  /korikeybinds proctest - Toggle proc debug mode")
    end
end
...
_G.KoriUI_RefreshKeybinds = UpdateAllKeybinds
_G.KoriUI_RefreshRotationHelper = RefreshRotationHelper
