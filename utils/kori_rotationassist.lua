...
CreateIconFrame = function()
    ...
    -- Main frame
    iconFrame = CreateFrame("Button", "KoriUI_RotationAssistIcon", UIParent, "BackdropTemplate")
...
_G.KoriUI_RefreshRotationAssistIcon = RefreshRotationAssistIcon
