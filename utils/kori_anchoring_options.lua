...
local KORI_Anchoring_Options = {}
ns.KORI_Anchoring_Options = KORI_Anchoring_Options
...
---------------------------------------------------------------------------
function KORI_Anchoring_Options:CreateAnchorDropdown(parent, label, settingsDB, anchorKey, x, y, width, onChange, includeList, excludeList, excludeSelf)
    if not ns.KORI_Anchoring or not ns.KORI_Anchoring.GetAnchorTargetList then
        return nil
    end
    ...
    local function GetAnchorOptions()
        return ns.KORI_Anchoring:GetAnchorTargetList(includeList, excludeList, excludeSelf)
    end
...
---------------------------------------------------------------------------
function KORI_Anchoring_Options:CreateSnapButton(parent, text, x, y, width, height, onClick)
    width = width or 100
    height = height or 24
...
---------------------------------------------------------------------------
function KORI_Anchoring_Options:CreateSnapButtonsRow(parent, label, x, y, snapTargets, settingsDB, anchorKey, getFrame, onSnap, onFailure, spacing, buttonWidth, buttonHeight, labelWidth)
    ...
    for i, snapTarget in ipairs(snapTargets) do
        local button = self:CreateSnapButton(
            ...
            function()
                ...
                local success = ns.KORI_Anchoring:SnapTo(
                    frame,
...
---------------------------------------------------------------------------
function KORI_Anchoring_Options:GetNinePointAnchorOptions()
    return {
...
---------------------------------------------------------------------------
function KORI_Anchoring_Options:CreateAnchorPointSelector(parent, label, settingsDB, key, x, y, onChange, size)
    size = size or 200
    local C = GetColors()
...
---------------------------------------------------------------------------
function KORI_Anchoring_Options:CreateMultiAnchorPopover(anchorButton, settingsDB, onChange, anchorsKey, maxAnchors)
...
---------------------------------------------------------------------------
function KORI_Anchoring_Options:CreateAnchorPresetControls(parent, settingsDB, x, y, onChange, PAD, FORM_ROW, anchorsKey, maxAnchors, onPresetChange)
    anchorsKey = anchorsKey or "anchors"
    maxAnchors = maxAnchors or 2
...
---------------------------------------------------------------------------
function KORI_Anchoring_Options:CreateMultiAnchorDialog(settingsDB, onChange, anchorsKey, maxAnchors)
    anchorsKey = anchorsKey or "anchors"
    maxAnchors = maxAnchors or 2
...
---------------------------------------------------------------------------
function KORI_Anchoring_Options:CreateMultiAnchorControls(parent, settingsDB, x, y, onChange, PAD, FORM_ROW, anchorsKey, maxAnchors)
    anchorsKey = anchorsKey or "anchors"
    maxAnchors = maxAnchors or 2
...
---------------------------------------------------------------------------
function KORI_Anchoring_Options:CreateAnchorPointControls(parent, settingsDB, x, y, onChange, PAD, FORM_ROW, sourceKey, targetKey, sourceLabel, targetLabel)
...
---------------------------------------------------------------------------
function KORI_Anchoring_Options:CreateOffsetControls(parent, settingsDB, x, y, onChange, PAD, FORM_ROW)
    local GUI = GetGUI()
    if not GUI then
        return nil, nil, y
    end
...
---------------------------------------------------------------------------
function KORI_Anchoring_Options:CreateAnchorControls(parent, settingsDB, x, y, onChange, PAD, FORM_ROW, anchorKey, anchorsKey, maxAnchors, excludeSelf, dropdownLabel, offsetMin, offsetMax, onPresetChange)
