...
local function CreateTextFrame()
    ...
    local frame = CreateFrame("Frame", "KoriUI_CombatText", UIParent)
...
---------------------------------------------------------------------------
_G.KoriUI_RefreshCombatText = RefreshCombatText

---------------------------------------------------------------------------
-- Global preview function for options panel
---------------------------------------------------------------------------
_G.KoriUI_PreviewCombatText = function(message)
