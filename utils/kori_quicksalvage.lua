...
local SalvageButton = CreateFrame("Button", "KoriUI_QuickSalvageButton", UIParent, table.concat(TEMPLATES, ','))
...
---------------------------------------------------------------------------
function _G.KoriUI_RefreshQuickSalvage()
    if not InCombatLockdown() then
        SalvageButton:UpdateAttributeDriver()
    end
end
...
QuickSalvage.Refresh = _G.KoriUI_RefreshQuickSalvage
