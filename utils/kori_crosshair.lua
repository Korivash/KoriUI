...
local function UpdateRangeChecking()
    ...
    if not rangeCheckFrame then
        rangeCheckFrame = CreateFrame("Frame", "KoriUI_CrosshairRangeCheck", UIParent)
...
local function CreateCrosshair()
    ...
    crosshairFrame = CreateFrame("Frame", "KoriUI_Crosshair", UIParent)
