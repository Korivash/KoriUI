...
---------------------------------------------------------------------------
-- Import shared functions from kori_character.lua
...
local function SetInspectExtendedMode(tabNum)
    ...
    if _G.KORI_InspectFrameSkinning and _G.KORI_InspectFrameSkinning.SetExtended then
        _G.KORI_InspectFrameSkinning.SetExtended(true)
    end
...
local function SetInspectNormalMode()
    ...
    if _G.KORI_InspectFrameSkinning and _G.KORI_InspectFrameSkinning.SetExtended then
        _G.KORI_InspectFrameSkinning.SetExtended(false)
    end
...
local function CreateInspectSettingsButton()
    ...
    local gearBtn = CreateFrame("Button", "KORI_InspectSettingsBtn", InspectFrame, "BackdropTemplate")
    ...
    inspectSettingsPanel = CreateFrame("Frame", "KoriUI_InspectSettingsPanel", InspectFrame, "BackdropTemplate")
    ...
    if generalDB then
        bgColorPicker = GUI:CreateFormColorPicker(scrollChild, "Background Color", "skinBgColor", generalDB, function()
            ...
            if _G.KORI_InspectFrameSkinning and _G.KORI_InspectFrameSkinning.Refresh then
                _G.KORI_InspectFrameSkinning.Refresh()
            end
        end)
...
---------------------------------------------------------------------------
-- Update inspect frame (called from kori_character.lua's ScheduleUpdate)
---------------------------------------------------------------------------
