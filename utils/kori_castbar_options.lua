--[[
    KoriUI Castbar Options
    Extracted from kori_options.lua for better organization
...
local mainOptions = ns.KORI_Options or {}
...
local function BuildCastbarOptions(tabContent, unitKey, y, PAD, FORM_ROW, RefreshUnit, GetTextureList, NINE_POINT_ANCHOR_OPTIONS, GetUFDB, GetDB)
    ...
    if unitKey == "player" or unitKey == "target" or unitKey == "targettarget" or unitKey == "focus" or unitKey == "pet" or unitKey == "boss" then
        ...
        if unitKey == "player" then
            ...
            local defaultStageColors = KORI_Castbar and KORI_Castbar.STAGE_COLORS or {}
            local defaultFillColors = KORI_Castbar and KORI_Castbar.STAGE_FILL_COLORS or {}
