...
local PROC_GLOW_MASK = "Interface\\AddOns\\KoriUI\\assets\\iconskin\\ProcGlowMask"
...
function CustomTrackers:CreateBar(barID, config)
    ...
    local bar = CreateFrame("Frame", "KORI_CustomTracker_" .. barID, UIParent, "BackdropTemplate")
...
---------------------------------------------------------------------------
_G.KoriUI_RefreshCustomTrackersVisibility = UpdateCustomTrackersVisibility
_G.KoriUI_RefreshCustomTrackersMouseover = SetupCustomTrackersMouseoverDetector

-- Refresh keybind display on all custom tracker icons
_G.KoriUI_RefreshCustomTrackerKeybinds = function()
