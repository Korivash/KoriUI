...
local function CreateBackdrop()
    ...
    backdropFrame = CreateFrame("Frame", "KORI_MinimapBackdrop", Minimap)
...
local function CreateDatatextPanel()
    ...
    datatextFrame = CreateFrame("Frame", "KORI_DatatextPanel", UIParent)
...
if Minimap.ZoomIn and not Minimap.ZoomIn._KORI_ShowHooked then
    Minimap.ZoomIn._KORI_ShowHooked = true
...
if Minimap.ZoomOut and not Minimap.ZoomOut._KORI_ShowHooked then
    Minimap.ZoomOut._KORI_ShowHooked = true
