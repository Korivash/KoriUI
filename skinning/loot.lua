...
local function CreateLootSlot(parent, index)
    ...
    local slot = CreateFrame("Button", "KORI_LootSlot"..index, parent)
...
local function CreateLootWindow()
    ...
    local frame = CreateFrame("Frame", "KORI_LootFrame", UIParent, "BackdropTemplate")
...
local function CreateRollFrame(index)
    ...
    local frame = CreateFrame("Frame", "KORI_LootRollFrame"..index, UIParent, "BackdropTemplate")
    ...
    frame.timer:SetStatusBarTexture(LSM:Fetch("statusbar", "Korivash") or "Interface\\TargetingFrame\\UI-StatusBar")
...
local function CreateRollAnchor()
    local anchor = CreateFrame("Frame", "KORI_LootRollAnchor", UIParent, "BackdropTemplate")
...
local function SkinGroupLootHistoryFrame()
    ...
    if Timer then
        ...
        if Timer.Fill then
            Timer.Fill:SetTexture(LSM:Fetch("statusbar", "Korivash") or "Interface\\TargetingFrame\\UI-StatusBar")
