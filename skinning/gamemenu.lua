...
---------------------------------------------------------------------------
-- GAME MENU (ESC MENU) SKINNING + KORI UI BUTTON
---------------------------------------------------------------------------
...
_G.KoriUI_RefreshGameMenuColors = RefreshGameMenuColors
_G.KoriUI_RefreshGameMenuFontSize = RefreshGameMenuFontSize

---------------------------------------------------------------------------
-- KORI UI BUTTON INJECTION
---------------------------------------------------------------------------
...
if GameMenuFrame and GameMenuFrame.InitButtons then
    hooksecurefunc(GameMenuFrame, "InitButtons", function()
        -- Inject Kori UI button (always, regardless of skinning setting)
        InjectKoriUIButton()
