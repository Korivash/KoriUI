...
local function CreateOrUpdateBackground()
    ...
    if not customBg then
        customBg = CreateFrame("Frame", "KORI_CharacterFrameBg_Skin", CharacterFrame, "BackdropTemplate")
...
---------------------------------------------------------------------------
-- API: Set background extended mode (called by kori_character.lua)
---------------------------------------------------------------------------
...
local function SetupCharacterFrameSkinning()
    ...
    -- (kori_character.lua will extend if character pane customization is enabled)
    if PaperDollFrame then
        PaperDollFrame:HookScript("OnShow", function()
            if IsSkinningEnabled() then
                ...
                -- If charPaneEnabled, kori_character.lua will call SetCharacterFrameBgExtended(true)
            end
        end)
...
local function SkinEquipmentManager()
    ...
    local popup = _G.KoriUI_EquipMgrPopup
...
local function SkinTitleManagerPane()
    ...
    local popup = _G.KoriUI_TitlesPopup
...
---------------------------------------------------------------------------
_G.KORI_CharacterFrameSkinning = {
    -- Configuration
    CONFIG = CONFIG,
    ...
    -- Skinning functions (called by kori_character.lua)
    SkinEquipmentManager = SkinEquipmentManager,
    SkinTitleManager = SkinTitleManagerPane,
}

-- Legacy compatibility aliases (deprecated - use KORI_CharacterFrameSkinning table)
_G.KoriUI_RefreshCharacterFrameColors = RefreshCharacterFrameColors

-- Legacy global function aliases for kori_character.lua
_G.KORI_SkinEquipmentManager = SkinEquipmentManager
_G.KORI_SkinTitleManager = SkinTitleManagerPane
_G.KORI_SetCharacterFrameBgExtended = SetCharacterFrameBgExtended
