...
local function CreateKORIAltPowerBar()
    ...
    local bar = CreateFrame("StatusBar", "KoriUI_AltPowerBar", UIParent)
...
_G.KoriUI_RefreshPowerBarAltColors = RefreshPowerBarAltColors
...
_G.KoriUI_TogglePowerBarAltMover = ToggleMover
