...
_G.KoriUI_ResetReadyCheckPosition = ResetReadyCheckPosition
...
local function CreateMover()
    ...
    readyCheckMover = CreateFrame("Frame", "KoriUI_ReadyCheckMover", UIParent, "BackdropTemplate")
...
_G.KoriUI_ToggleReadyCheckMover = ToggleMover
...
_G.KoriUI_RefreshReadyCheckColors = RefreshReadyCheckColors
