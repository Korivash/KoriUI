...
---------------------------------------------------------------------------
local RING_TEXTURES = {
    thin     = "Interface\\AddOns\\KoriUI\\assets\\cursor\\kori_ring_thin.png",
    standard = "Interface\\AddOns\\KoriUI\\assets\\cursor\\kori_ring_standard.png",
    thick    = "Interface\\AddOns\\KoriUI\\assets\\cursor\\kori_ring_thick.png",
    solid    = "Interface\\AddOns\\KoriUI\\assets\\cursor\\kori_ring_solid.png",
}

-- Reticle options (mix of custom texture and Blizzard Atlas)
local RETICLE_OPTIONS = {
    dot     = { path = "Interface\\AddOns\\KoriUI\\assets\\cursor\\kori_reticle_dot.tga", isAtlas = false },
...
local function CreateReticle()
    ...
    ringFrame = CreateFrame("Frame", "KoriUI_Reticle", UIParent)
...
---------------------------------------------------------------------------
_G.KoriUI_RefreshReticle = function()
    InvalidateCache()
    UpdateReticle()
end
