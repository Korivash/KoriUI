...
local KORI_RaidBuffs = {}
ns.RaidBuffs = KORI_RaidBuffs
...
local function CreateMainFrame()
    ...
    mainFrame = CreateFrame("Frame", "KoriUI_MissingRaidBuffs", UIParent)
...
function KORI_RaidBuffs:RefreshColors()
    ApplySkin()
end

_G.KoriUI_RefreshRaidBuffColors = function()
    KORI_RaidBuffs:RefreshColors()
end
...
function KORI_RaidBuffs:Toggle()
    local settings = GetSettings()
    settings.enabled = not settings.enabled
    UpdateDisplay()
end

function KORI_RaidBuffs:ForceUpdate()
    UpdateDisplay()
    ApplySkin()
end

function KORI_RaidBuffs:Debug()
    local settings = GetSettings()
    local lines = {}
    local playerClass = SafeUnitClass("player")
...
function KORI_RaidBuffs:GetFrame()
    return mainFrame
end

function KORI_RaidBuffs:TogglePreview()
...
function KORI_RaidBuffs:IsPreviewMode()
    return previewMode
end

-- Global function for options panel
_G.KoriUI_ToggleRaidBuffsPreview = function()
    if ns.RaidBuffs then
